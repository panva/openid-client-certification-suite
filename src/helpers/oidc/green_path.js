...
module.exports = async function greenPath({
  ...
  const { client_auth_type: token_endpoint_auth_method, request_type, response_type } = variant
        ...
        keys: [
          {
            ...
            kid: await jose.calculateJwkThumbprint(privateKey),
            use: 'sig',
            alg: 'PS256',
          },
        ],
  ...
  let authorizationParams = {
    ...
    nonce:
      response_type.includes('id_token') || forceNonce === true ? generators.nonce() : undefined,
    response_mode,
    ...params,
  }
